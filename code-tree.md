...
- **src** (14173 lines)
    ...
    - **word** (2206 lines)
      ...
      - **ui** (1706 lines)
        - **components** (636 lines)
          ...
          - **translation** (40 lines)
            - WordTranslationBlock.jsx (40 lines)
          - **WordHeaderBlock** (75 lines)
  ...
  - **pages** (1345 lines)
    ...
    - **quiz** (228 lines)
      - **delf** (182 lines)
        - **comprehension-ecrite** (112 lines)
          - [level].js (38 lines)
          - index.js (74 lines)
        - **comprehension-orale** (22 lines)
          - **[level]** (22 lines)
            - [testId].tsx (22 lines)
        - index.js (46 lines)
        - **production-ecrite** (2 lines)
          - index.js (2 lines)
      - index.js (46 lines)
    - **search** (2 lines)
      - index.js (2 lines)
